<script lang="ts">
	...
	const testimonials: Testimonial[] = [
		...
		{ name: 'Sarah', child: 'Emma, 1 år', text: 'Det bedste valg vi har truffet. Emma elsker at komme i dagpleje, og vi kan mærke hvor glad og tilfreds hun er. Eline er super dygtig og kommunikationen er altid i top!', initials: 'S' },
		...
		{ name: 'Camilla', child: 'Sofie, 2 år', text: 'Eline er en sand stjerne! Vores datter elsker at være i hendes dagpleje, og vi kan se hvor tryg og glad hun er. Eline er utrolig omsorgsfuld og skaber en fantastisk atmosfære for børnene.', initials: 'C' },
